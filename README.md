...
| MsgRemoveForeignCoin                                    | 2     | Remove a foreign coin object from ZetaChain. The ZRC20 will still exist on ZetaChain and can still be traded but cross-chain capabilities will no longer be available for it                        | fungible   |
...
| MsgUpdateZRC20WithdrawFee                               | 2     | Update the withdraw protocol fees for a ZRC20. A flat fee paid for each                                                                                                                             | fungible   |
